...
export function dashboardUrl(apiUrl, scanId) {
  try {
...
export function parseFileOrString(raw) {
  if (!raw) return undefined;
  if (raw.startsWith("@")) {
    return readFileSync(raw.slice(1), "utf-8").trim();
  }
...
export function buildBody(target, opts) {
...
export function sevAboveThreshold(finding, threshold) {
